...
Our primary color palette. Dark backgrounds, all contrast ratios optimized for ~600 backgrounds.

<div class="color-grid">
  <ColorSwatchRow name="Zinc 950" variable="--zinc-950" hex="#09090b" />
  <ColorSwatchRow name="Zinc 900" variable="--zinc-900" hex="#18181b" />
  <ColorSwatchRow name="Zinc 800" variable="--zinc-800" hex="#27272a" />
  <ColorSwatchRow name="Zinc 700" variable="--zinc-700" hex="#3f3f46" />
  <ColorSwatchRow name="Zinc 600" variable="--zinc-600" hex="#52525b" />
  <ColorSwatchRow name="Zinc 500" variable="--zinc-500" hex="#71717a" />
  <ColorSwatchRow name="Zinc 400" variable="--zinc-400" hex="#a1a1aa" />
  <ColorSwatchRow name="Zinc 300" variable="--zinc-300" hex="#d4d4d8" />
  <ColorSwatchRow name="Zinc 200" variable="--zinc-200" hex="#e4e4e7" />
  <ColorSwatchRow name="Zinc 100" variable="--zinc-100" hex="#f4f4f5" />
  <ColorSwatchRow name="Zinc 50" variable="--zinc-50" hex="#fafafa" />
</div>
...
<div class="type-details">
  <div class="type-detail-card">
    ...
    <span class="detail-value">Inter, system-ui, sans-serif</span>
  </div>
  <div class="type-detail-card">
    <span class="detail-label">Line Heights</span>
    <span class="detail-value">1.25 (tight) - 1.75 (relaxed)</span>
  </div>
  <div class="type-detail-card">
    <span class="detail-label">Letter Spacing</span>
    <span class="detail-value">-0.025em (headings), normal (body)</span>
  </div>
</div>
